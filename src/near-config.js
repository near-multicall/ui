function getConfig(env) {
  ...
  case 'mainnet':
    return {
      ...
      PARAS_MARKETPLACE_ADDRESS: "marketplace.paras.near",
      PARAS_NFT_ADDRESS: "x.paras.near",
  ...
  case 'testnet':
    return {
      ...
      PARAS_MARKETPLACE_ADDRESS: "paras-marketplace-v2.testnet",
      PARAS_NFT_ADDRESS: "paras-token-v2.testnet",
